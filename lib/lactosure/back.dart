...
//     // MACHINE DATA
//     int fatRaw = (frame[3] << 8) | frame[4];
//     int proteinRaw = (frame[5] << 8) | frame[6];
//     int snfRaw = (frame[7] << 8) | frame[8];
//     int tempRaw = (frame[11] << 8) | frame[12];
//     int waterRaw = (frame[13] << 8) | frame[14];

//     // CLR not available in this packet
//     int clrRaw = 0;

//     debugPrint("fatRaw => $fatRaw");
//     debugPrint("proteinRaw => $proteinRaw");
//     debugPrint("snfRaw => $snfRaw");
//     debugPrint("tempRaw => $tempRaw");
//     debugPrint("waterRaw => $waterRaw");

//     setState(() {
//       fatController.text = (fatRaw / 100).toStringAsFixed(2);

//       snfController.text = (snfRaw / 100).toStringAsFixed(2);

//       clrController.text = (clrRaw / 100).toStringAsFixed(2);

//       proteinController.text = (proteinRaw / 100).toStringAsFixed(2);

//       tempController.text = (tempRaw / 10).toStringAsFixed(1);

//       waterController.text = (waterRaw / 10).toStringAsFixed(1);
//     });
//   }
